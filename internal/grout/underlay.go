...
func SetupUnderlay(ctx context.Context, client *Client, params hostnetwork.UnderlayParams) error {
	...
	for _, underlayInterface := range params.UnderlayInterfaces {
		...
		if err := netnamespace.In(ns, func() error {
			return configureUnderlayInterface(ctx, client, underlayInterface)
		}); err != nil {
			return err
		}
	}
...
func configureUnderlayInterface(ctx context.Context, client *Client, underlayInterface string) error {
